 ...
 *
 * This client connects to an RTVI-compatible bot server using SmallWebRTC.
 *
 * Requirements:
...
class SmallWebRTCClientApp {
  ...
  constructor() {
    console.log('SmallWebRTCClientApp');
  ...
  public async connect(): Promise<void> {
    try {
      ...
      //   endpoint: import.meta.env.VITE_SmallWebRTC_URL + "/connect",
      // });
...
declare global {
  interface Window {
    SmallWebRTCClientApp: typeof SmallWebRTCClientApp;
  }
}

window.addEventListener('DOMContentLoaded', () => {
  window.SmallWebRTCClientApp = SmallWebRTCClientApp;
  new SmallWebRTCClientApp();
});
